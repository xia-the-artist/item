<?php
    ...
    // sql语句 查询
    $sql = "select * from dengluzc where username='$username' and password='$password'";
    ...
    if($res->num_rows>0){
        ...
        echo '<script>location.href="../dior.html";</script>';
    }else{

        echo '<script>alert("无效用户名，请创建您的账户.");</script>';
