            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    res.forEach(elm => {
                        ...
                        console.log(pic);
                        temp += ` <li class="universe-card">
                        <a href="/zh_cn/products/beauty-Y0715201-真我-香水">
                            <div class="image" style="display:table;position:relative;width:100%;padding-bottom:108.12143227815257%;overflow:hidden">
                                <div class="lazyload-placeholder"></div> <img src="${baseUrl}/${pic[0].src}" alt="${baseUrl}/${pic[0].title}" style=" position: absolute; width: 100%; top: 0; left: 0;"
                                /></div>
